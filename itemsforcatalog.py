...
catalogItem1 = ListItems(user_id=1, name = "Two shingaurds", description = "Description for two shingaurd ", category = category1)

session.add(catalogItem1)
session.commit()


catalogItem2 = ListItems(user_id=1, name = "Shingaurds", description = "Description for shingaurd", category = category1)
